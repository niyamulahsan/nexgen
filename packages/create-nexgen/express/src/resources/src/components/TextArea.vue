...
const wrapperClass = computed(() => (topclass.value ? `${topclass.value} position-relative` : "mb-2"));
...
const maxCounter = computed(() => (max.value == null ? "" : max.value - String(props.modelValue).length));
